...
My API key is no longer attached due to this now being made public on GitHub, if you wish to test the LLM intergration then fill in the sace on line 14 of main with a key.
